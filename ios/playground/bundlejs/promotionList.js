...
exports.default = {
  ...
  methods: {
    ...
    loadData: function loadData() {
      ...
      stream.fetch({
        method: 'POST',
        url: '//cas.secoo.com/api/distribute/product/promotion_product',
        body: 'pageSize=' + that.pageSize + '&status=3&currentPage=' + that.currentPage,
        type: 'json'
      }, function (res) {
        if (!res.ok) {
          modal.toast({
          ...
          if (data.retCode == 0) {
            ...
            if (data.retData.product.length == that.pageSize) {
              that.currentPage++;
            }
          }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('list', {
    ...
    return _c('cell', {
      ...
      attrs: {
        "src": "//distribute.secoo.com/weex/img/highReturn.png"
      }
    })]), _c('div', {
  ...
  return _c('loading', [_c('text', [_vm._v("上拉加载")]), _c('loading-indicator', {
    staticClass: ["indicator"]
  })])
}]}
